...
func decodeBalanceWithdrawalResponse(resp *http.Response) (res BalanceWithdrawalRes, _ error) {
	switch resp.StatusCode {
	case 200:
		// Code 200.
		return &BalanceWithdrawalOK{}, nil
	case 401:
		// Code 401.
		return &BalanceWithdrawalUnauthorized{}, nil
	case 402:
		// Code 402.
		return &BalanceWithdrawalPaymentRequired{}, nil
	case 422:
		// Code 422.
		return &BalanceWithdrawalUnprocessableEntity{}, nil
	case 500:
		// Code 500.
...
func decodeGetOrdersNumberListResponse(resp *http.Response) (res GetOrdersNumberListRes, _ error) {
	...
	case 200:
		...
		case ct == "application/json":
			...
			var response GetOrdersNumberListResponse
			if err := func() error {
				if err := response.Decode(d); err != nil {
					return err
				}
	...
	case 204:
		// Code 204.
		return &GetOrdersNumberListNoContent{}, nil
	case 401:
		// Code 401.
		return &GetOrdersNumberListUnauthorized{}, nil
	case 500:
		// Code 500.
...
func decodeGetUserBalanceResponse(resp *http.Response) (res GetUserBalanceRes, _ error) {
	...
	case 401:
		// Code 401.
		return &GetUserBalanceUnauthorized{}, nil
	case 500:
		// Code 500.
...
func decodeGetWithdrawalsResponse(resp *http.Response) (res GetWithdrawalsRes, _ error) {
	...
	case 200:
		...
		case ct == "application/json":
			...
			var response GetWithdrawalsResponse
			if err := func() error {
				if err := response.Decode(d); err != nil {
					return err
				}
...
func decodeOrderNumberLoadResponse(resp *http.Response) (res OrderNumberLoadRes, _ error) {
	...
	case 200:
		// Code 200.
		return &OrderNumberLoadOK{}, nil
	case 202:
		// Code 202.
		return &OrderNumberLoadAccepted{}, nil
	case 400:
		// Code 400.
		return &OrderNumberLoadBadRequest{}, nil
	case 401:
		// Code 401.
		return &OrderNumberLoadUnauthorized{}, nil
	case 409:
		// Code 409.
		return &OrderNumberLoadConflict{}, nil
	case 422:
		// Code 422.
		return &OrderNumberLoadUnprocessableEntity{}, nil
	case 500:
		// Code 500.
